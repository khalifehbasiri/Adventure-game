...
public class Room 
{
     ...
     * 
     * @return ArrayList<Room> - Returns the static arrayList.
     */
    public static ArrayList<Room> roomLst() 
    {
        return roomsList;
    }
    ...
    /**
     * Returns Item based on their name.
     * 
     * @param itemInRoom - item.
     * 
     * @return Item - Returns Item based on their name.
     */
    public Item getItem(String itemInRoom) 
    {
        for (Item i : items) {
            if (i.getName().equals(itemInRoom)){
                return i;
            }
        }
        return null; 
     ...
     * @return Item - Returns Item based on their name.
     */
    public boolean contain(Item itemInRoom) 
    {
        for (Item i : items) {
            if (i == itemInRoom){
                return true;
     ...
     * 
     * @param item The item to remove in the room
     */
